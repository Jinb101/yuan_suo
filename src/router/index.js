...
const router = new Router({
  routes: [
    ...
    routerObj(
      "/approval_my",
      "index/approval/my.vue",
      "approvalMy",
      "我的审批"
    ),
    routerObj(
      "/approval_my/:id&:did&:child",
      "index/approval/my.vue",
      "approvalMys",
      "我的审批详情"
    ),
    routerObj(
      "/approval_send",
      "index/approval/send.vue",
      "approvalSend",
      "发起审批"
    ),
    routerObj(
      "/approval_send/:id&:ids",
      "index/approval/send.vue",
      "approvalSends2",
      "发起"
    ),
    ...
    routerObj(
      "/finance_select",
      "finance/select/index.vue",
      "financeselect",
      "查凭证"
    ),
    routerObj(
      "/finance_bill",
      "finance/select/bill.vue",
      "financebill",
      "收支账"
    ),
    ...
    routerObj(
      "/finance_setting",
      "finance/setting/index.vue",
      "financesetting",
      "参数设定"
    ),
    routerObj(
      "/finance_classify",
      "finance/setting/classify.vue",
      "financeclassify",
      "分类管理"
    ),
    routerObj(
      "/finance_card",
      "finance/setting/card.vue",
      "financecard",
      "账户管理"
    ),
    routerObj(
      "/finance_customer",
      "finance/code/customer.vue",
      "financecustomer",
      "客户管理"
    ),
    routerObj(
      "/finance_supplier",
      "finance/code/supplier.vue",
      "financesupplier",
      "供应商管理"
    ),
    routerObj(
      "/finance_staff",
      "finance/staff/index.vue",
      "financestaff",
      "员工管理"
    ),
    ...
    routerObj(
      "/finance_account",
      "finance/select/account.vue",
      "financeaccount",
      "账户余额"
    ),
    routerObj(
      "/finance_daily",
      "finance/select/daily.vue",
      "financedaily",
      "现金日报"
    ),
    routerObj(
      "/finance_month",
      "finance/select/month.vue",
      "financemonth",
      "月度财报"
    ),
    routerObj(
      "/finance_year",
      "finance/select/year.vue",
      "financeyear",
      "期间财报"
    ),
    ...
    routerObj(
      "/my_attendance",
      "user/my/attendance.vue",
      "userattendance",
      "我的考勤"
    ),
    routerObj(
      "/my_autograph",
      "user/my/autograph.vue",
      "userautograph",
      "我的签名"
    ),
    ...
    routerObj(
      "/event_repair",
      "user/event/repair.vue",
      "userrepair",
      "维修申请"
    ),
    routerObj(
      "/event_framework",
      "user/event/framework.vue",
      "userframework",
      "组织架构"
    ),
    ...
    routerObj(
      "/environment_my",
      "user/environment/my.vue",
      "userenvironmentmy",
      "我的环创集"
    ),
    routerObj(
      "/environment_my/:type&:id",
      "user/environment/my.vue",
      "userenvironmentmy1",
      "我的环创集"
    ),
    ...
    routerObj(
      "/work_semester",
      "work/work/semester.vue",
      "worksemester",
      "学期工作"
    ),
    routerObj(
      "/work_semester_person",
      "work/work/semester_person.vue",
      "worksemesterperson",
      "学期工作"
    ),
    ...
    routerObj(
      "/work_supplies",
      "work/logistics/supplies.vue",
      "worksupplies",
      "物资列表"
    ),
    routerObj(
      "/work_visit",
      "work/logistics/visit.vue",
      "workvisit",
      "来访登记"
    ),
    routerObj(
      "/work_visitcode/:id",
      "work/logistics/visitcode.vue",
      "workvisitcode",
      "来访登记二维码"
    ),

    routerObj(
      "/work_foodorder/:type&:status&:id",
      "work/logistics/foodorder.vue",
      "workfoodorder",
      "食材订单详情"
    ),
    routerObj(
      "/work_foodorder/:type&:status",
      "work/logistics/foodorder.vue",
      "workfoodorder1",
      "食材订单"
    ),
    ...
    routerObj(
      "/work_recipes_history/:id",
      "work/health/recipes_history.vue",
      "workrecipeshistory",
      "老师历史食谱"
    ),
    routerObj(
      "/work_recipes_history",
      "work/health/recipes_history.vue",
      "workrecipeshistory2",
      "宝宝历史食谱"
    ),
    ...
    routerObj(
      "/work_timetable",
      "work/class/timetable.vue",
      "worktimetable",
      "班级课表"
    ),
    routerObj(
      "/work_rewardrule",
      "work/class/reward_rule.vue",
      "workrewardrule",
      "宝宝奖分规则"
    ),
    routerObj(
      "/work_connection",
      "work/class/connection.vue",
      "workconnection",
      "家园联系册"
    ),
    routerObj(
      "/work_connection/:id&:his",
      "work/class/connection.vue",
      "workconnections1",
      "家园联系册"
    ),
    ...
    routerObj(
      "/connection",
      "work/connection/index.vue",
      "connection1",
      "家园联系册"
    ),
    routerObj(
      "/connection/:type&:id&:his",
      "work/connection/index.vue",
      "connection2",
      "家园联系册"
    ),
    ...
    routerObj(
      "/work_integral",
      "work/class/integral.vue",
      "workintegral",
      "积分记录"
    ),
    routerObj(
      "/work_integralrank",
      "work/class/integral_rank.vue",
      "workintegralrank",
      "积分榜"
    ),
    routerObj(
      "/work_parent",
      "work/class/parent.vue",
      "workparent",
      "家长入驻/绑定核验"
    ),
    routerObj(
    ...
    routerObj(
      "/work_chant/:sid&:tid&:id&:videoid",
      "work/class/chant.vue",
      "workchant0",
      "国学"
    ),
    routerObj(
      "/work_chant/:sid&:tid&:id",
      "work/class/chant.vue",
      "workchant1",
      "国学"
    ),
    ...
    routerObj(
      "/work_recruit",
      "work/recruit/index.vue",
      "workrecruit",
      "招生工作"
    ),
    routerObj(
      "/work_recruit/:type&:id",
      "work/recruit/index.vue",
      "workrecruits1",
      "招生工作"
    ),
    ...
    routerObj(
      "/work_kindergarten",
      "work/affairs/kindergarten.vue",
      "workkindergarten",
      "园所风采"
    ),
    routerObj(
      "/work_kindergarten/:type",
      "work/affairs/kindergarten.vue",
      "workkindergartens",
      "园所风采"
    ),
    ...
    routerObj(
      "/work_organization",
      "work/affairs/organization.vue",
      "workorganization",
      "编制管理"
    ),
    routerObj(
      "/work_organization/:id",
      "work/affairs/organization.vue",
      "workorganizations",
      "编制管理"
    ),
    routerObj(
      "/work_recruitteach",
      "work/affairs/recruit.vue",
      "workrecruitteach",
      "招聘管理"
    ),
    routerObj(
      "/work_recruitteach/:id",
      "work/affairs/recruit.vue",
      "workrecruitteach2",
      "招聘管理"
    ),
    routerObj(
      "/work_address",
      "work/affairs/address.vue",
      "workaddress",
      "热线地址"
    ),
    routerObj(
      "/work_affairsdata",
      "work/affairs/affairsdata.vue",
      "workaffairsdata",
      "数据管理"
    ),
    routerObj(
      "/work_menulevel",
      "work/affairs/menulevel.vue",
      "workmenulevel",
      "功能管理"
    ),
    ...
    routerObj(
      "/management_baby",
      "work/management/baby/index.vue",
      "managementbaby",
      "宝贝在线"
    ),
    routerObj(
    ...
    routerObj(
      "/management_class",
      "work/management/class/index.vue",
      "managementclass",
      "班级管理"
    ),
    routerObj(
      "/management_classlist",
      "work/management/class/list.vue",
      "managementclasslist",
      "班级列表"
    ),
    routerObj(
      "/management_classlist/:type&:id",
      "work/management/class/list.vue",
      "managementclasslist1",
      "班级名单"
    ),
    routerObj(
      "/management_classlist/:type",
      "work/management/class/list.vue",
      "managementclasslist2",
      "班级列表"
    ),
    routerObj(
      "/management_classsplit",
      "work/management/class/class.vue",
      "managementclassclass",
      "已分班"
    ),
    routerObj(
      "/management_classsplit/:id&:type",
      "work/management/class/class.vue",
      "managementclassclass2",
      "已分班"
    ),
    routerObj(
      "/management_classsplit/:id",
      "work/management/class/class.vue",
      "managementclassclass3",
      "已分班"
    ),
    routerObj(
      "/management_classnot",
      "work/management/class/not_class.vue",
      "managementclassnotclass",
      "未分班"
    ),
    routerObj(
      "/management_classnot/:id",
      "work/management/class/not_class.vue",
      "managementclassnotclass2",
      "未分班"
    ),

    routerObj(
      "/management_record",
      "work/management/record/index.vue",
      "managementrecord",
      "园所数据"
    ),
    routerObj(
      "/management_record2",
      "work/management/record/old.vue",
      "managementrecord2",
      "园所数据"
    ),
    // routerObj('/management_achievements', 'work/management/achievements/index.vue', 'managementachievements', '绩效积分管理'),
    routerObj(
      "/management_achievements_set",
      "work/management/achievements/set.vue",
      "managementachievementsset",
      "绩效考核表管理"
    ),
    routerObj(
      "/management_achievements_set/:id",
      "work/management/achievements/set.vue",
      "managementachievementsset2",
      "绩效考核表管理"
    ),
    routerObj(
      "/management_achievements_wait",
      "work/management/achievements/wait.vue",
      "managementachievementswait",
      "待我考核表"
    ),
    routerObj(
      "/management_achievements_wait/:type&:id",
      "work/management/achievements/wait.vue",
      "managementachievementswait2",
      "待我考核表"
    ),
    routerObj(
      "/management_achievements_my",
      "work/management/achievements/my.vue",
      "managementachievementsmy",
      "我的考核表"
    ),
    routerObj(
      "/management_achievements_my/:type&:id",
      "work/management/achievements/my.vue",
      "managementachievementsmy2",
      "我的考核表"
    ),

    routerObj(
      "/management_integral_level",
      "work/management/integral/level.vue",
      "managementintegrallevel",
      "积分榜"
    ),
    routerObj(
      "/management_integral_level/:type",
      "work/management/integral/level.vue",
      "managementintegrallevel2",
      "积分榜"
    ),
    routerObj(
      "/management_integral_my",
      "work/management/integral/my.vue",
      "managementintegralmy",
      "我的积分"
    ),
    routerObj(
      "/management_integral",
      "work/management/integral/index.vue",
      "managementintegral1",
      "奖分"
    ),
    routerObj(
      "/management_integral/:id",
      "work/management/integral/index.vue",
      "managementintegral2",
      "扣分"
    ),
    routerObj(
      "/management_integral_file",
      "work/management/integral/file.vue",
      "managementintegralfile",
      "积分管理制度"
    ),
    ...
    routerObj(
      "/work_survey_list",
      "work/survey/list.vue",
      "worksurveylist",
      "调研记录"
    ),
    routerObj(
      "/work_repair",
      "work/repair/index.vue",
      "workrepair",
      "维修申报"
    ),
    routerObj(
    ...
    // routerObj("/artCard", "user/art_style/index.vue", "artCard", "艺体中心"),
