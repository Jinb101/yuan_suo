    ...
    <section v-for="(i, j) in item"
      ...
      <div class="tool flex">
        <van-button size="small"
                    ...
                    plain
                    type="primary"
                    @click="ongetsmoney(i, j)">收款</van-button>
        <van-button size="small"
                    round
                    plain
                    type="info"
                    @click.stop="onsets(i)">催款</van-button>
      </div>
    </section>
    <v-f v-model="open"
         :footer="false"
