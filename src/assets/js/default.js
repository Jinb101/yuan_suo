...
let userdef = fn([
  ...
  // ["artCard", "艺体中心", icons(28, "n", 7025), 0, { id: 4020 }],
...
let qhys = fn([
  ["event_kindergarten", "切换园所", icons(18, "n", 519), 0, { id: 4019 }]
]);
if (config.moreid) {
      ...
      children: [
        {
          ...
          value: 1,
          text: "春" + sms,
          disabled: isdis ? false : dis
        },
        {
          name: "秋" + sms,
          value: 2,
          text: "秋" + sms,
          disabled: isdis ? false : dis2
        }
      ]
    });
  }
...
let record = {
  ...
  api: ["recordread", "recordreg", "recordatten", "recordfood", "recorddata"],
  year: record_year(),
