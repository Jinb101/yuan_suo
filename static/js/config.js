...
demo.access(
  ...
  (() => {
    ...
    let api = (() => {
      ...
      return {
        ...
        clockin: data => {
          ...
          let h5 = demo
            .es6()
            .encrypt({ ...data }, "clock", "clock", "CLOCKINTOIMAGE");
          return s + h5;
        }
      };
    })();
    ...
    theme.linear = demo.$alg.gradients(
      180,
      theme.color,
      ...theme.colors,
      "rgba(255,255,255,0)"
...
demo.access("siteApi", () => {
  ...
  let b202207 = {
    ...
    approvalMyWaitDetail: fn(
      "approvaltomedetail",
      "我的审批 - 待我审批详情",
      3
    ),
    approvalMyNoticeDetail: fn(
      "approvalinformmedetail",
      "我的审批 - 知会我的详情",
      3
    ),
    ...
    babyWatchList: fn("nursery/baby_online/WatchList", "宝贝在线观看记录"),
    babyRecView: fn(
      "nursery/baby_online/BabyViewingRecords",
      "记录宝贝在线观看记录"
    ),
    ...
    financevouchercheck: fn(
      "financial_affairs/voucherToBeEntered",
      "检查待录入",
      2
    ),
    financevoucherdelcheck: fn(
      "financial_affairs/deleteCertificate",
      "删除待录入",
      2
    ),
    financevoucherget: fn("financial_affairs/index", "查凭证", 2),
    financevoucheredit: fn("financial_affairs/evidence", "编辑", 2),
    financevoucherstatus: fn(
      "financial_affairs/financialConfirmation",
      "审核",
      2
    ),
    ...
    financeauxiliary: fn(
      "financial_affairs/getAuxiliaryCategory",
      "辅助分类",
      2
    ),
    financedaily: fn("financial_statistics/cash_daily", "现金日报", 2),
    financemonthly: fn(
      "financial_statistics/monthly_financial_report",
      "月度财报",
      2
    ),
    ...
    userphonegovernmentedit: fn(
      "editGovernmentAddressBook",
      "编辑政务通讯录",
      9
    ),
    userphonegovernmentdel: fn(
      "deleteGovernmentAddressBook",
      "删除政务通讯录",
      9
    ),
